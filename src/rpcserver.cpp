...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BBEE features */
        {"bbee", "masternode", &masternode, true, true, false},
        {"bbee", "masternodelist", &masternodelist, true, true, false},
        {"bbee", "mnbudget", &mnbudget, true, true, false},
        {"bbee", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"bbee", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bbee", "mnsync", &mnsync, true, true, false},
        {"bbee", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"bbee", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bbeed, or the -server option to bbee-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bbee-cli " + methodname + " " + args + "\n";
}
