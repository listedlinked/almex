/* src/config/bbee-config.h.  Generated from bbee-config.h.in by configure.  */
/* src/config/bbee-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BBEE_CONFIG_H

#define BBEE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://bbee.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bbee Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bbee Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bbee"
