...
VERSION=
commit=false
url=https://github.com/listedlinked/almex
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/listedlinked/almex
...
then
    ...
    git clone https://github.com/listedlinked/almex.SIGS.git
